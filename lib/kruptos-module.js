...
moduleEncryptedFileExtension = function (module, filename) {
...
Module._findPath = function (request, paths) {
  ...
  if (filename.indexOf('node_modules') !== -1 || config.cryptKey === null) {
    Module.wrap = _Module.wrap;
    return filename;
  }
  Module.wrap = wrap;
